...
@implementation UIImage (RYImageEffects)
...
+ (UIImage *)imageByApplyingLightRYEffectToImage:(UIImage*)inputImage
{
    ...
    return [self imageByApplyingRYBlurToImage:inputImage withRadius:60 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)imageByApplyingExtraLightRYEffectToImage:(UIImage*)inputImage
{
    ...
    return [self imageByApplyingRYBlurToImage:inputImage withRadius:40 tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
+ (UIImage *)imageByApplyingTintRYEffectWithColor:(UIColor *)tintColor toImage:(UIImage*)inputImage
{
    ...
    return [self imageByApplyingRYBlurToImage:inputImage withRadius:20 tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
